package me.cresterida.conf.entity;
...
@Entity
@Table(schema = "public", name = "oauth_client_details")

public class ClientsDetailsCustom implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientsDetailsCustom)) return false;

        ClientsDetailsCustom that = (ClientsDetailsCustom) o;
